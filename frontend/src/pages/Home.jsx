...
const Home = () => {
  ...
  try {
    ...
    toggleLike = gameContext.toggleLike;
    toggleCart = gameContext.toggleCart;
    isLiked = gameContext.isLiked;
    isInCart = gameContext.isInCart;
  } catch (contextError) {
    console.error("GameContext Error:", contextError);
    // Use fallback data
    games = [
      {
        id: 1,
  ...
  return (
    ...
    >
      ...
      >
        ...
        {!loading && !error && otherGames.length > 0 && (
          <div
            style={{
              display: "grid",
